...
class DatabaseCloneService:
    def __init__(self, authorisation_service: AuthorisationService, clone_api_url: str):
    ...
    def create_clone(self, database_clone_model: DatabaseCloneModel):
        response = requests.post(
            ...
            json=self.__create_request_body(database_clone_model))
    ...
    @staticmethod
    def __create_request_body(database_clone_model: DatabaseCloneModel):
